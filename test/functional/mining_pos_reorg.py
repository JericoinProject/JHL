...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected JHL supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check JHL supply at the beginning
        # ------------------------------------------
        # JHL supply: block rewards minus burned fees for minting
        ...
        # Verify that JHL supplies were properly updated after the spends and reorgs
        self.log.info("Check JHL supply...")
