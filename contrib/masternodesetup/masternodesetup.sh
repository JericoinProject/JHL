...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='jericoin.conf'
CONFIGFOLDER='/root/.jericoin'
COIN_DAEMON='jericoind'
COIN_CLI='jericoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/JericoinProject/JHL/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
