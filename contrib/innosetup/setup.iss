...
#define MyAppName "Jericoin Core"
#define MyAppPublisher "2022 JericoinProject Core Developers"
#define MyAppURL "https://jericoin.com"
#define MyAppExeName "jericoin-qt.exe"
#define MyAppExtraData "https://explorer.JericoinProject.net/bootstraps/JHL/bootstrap.zip"
...
DefaultDirName={autopf}\Jericoin
...
OutputDir=.\output
OutputBaseFilename=JericoinSetup
...
DefaultGroupName=Jericoin Core
...
[Files]
Source: ".\package\jericoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Jericoin\Jericoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Jericoin\Jericoin-Qt,strDataDir|{userappdata}\Jericoin\}');
  Result := True;
end;
