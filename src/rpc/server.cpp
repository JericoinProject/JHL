...
// Copyright (c) 2024 JericoinProject Core Developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* JHL features */
        {"jericoin", "listmasternodes", &listmasternodes, true },
        {"jericoin", "getmasternodecount", &getmasternodecount, true },
        {"jericoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"jericoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"jericoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"jericoin", "masternodecurrent", &masternodecurrent, true },
        {"jericoin", "startmasternode", &startmasternode, true },
        {"jericoin", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"jericoin", "createmasternodekey", &createmasternodekey, true },
        {"jericoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"jericoin", "listmasternodeconf", &listmasternodeconf, true },
        {"jericoin", "getactivemasternodecount", &getactivemasternodecount, true },
        {"jericoin", "getmasternodestatus", &getmasternodestatus, true },
        {"jericoin", "getmasternodewinners", &getmasternodewinners, true },
        {"jericoin", "getmasternodescores", &getmasternodescores, true },
        {"jericoin", "mnsync", &mnsync, true },
        {"jericoin", "spork", &spork, true },
        {"jericoin", "mnping", &mnping, true },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15376/\n";
}
