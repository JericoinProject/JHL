Contributing to Jericoin Core
============================

The Jericoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Jericoin Core project, and is not to be
confused with overall Jericoin Network Protocol consensus changes.

Whether a pull request is merged into Jericoin Core rests with the project merge
...
Patches that change Jericoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Jericoin consensus, it must have been
...
The project leader is the release manager for each Jericoin Core release.
